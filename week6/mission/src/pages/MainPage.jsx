...
function MainPage () {
    ...
    const debounceSearchMovie = useCallback(debounce(searchMovie, 500), []); //500ms 지연

    const handleChange = (event) => {
        const keyword = event.target.value;
        setSearch(keyword);
        debounceSearchMovie(keyword); //debounce 적용
    };
    ...
    return (
        <MainWrapper>
            <BackgroundImg>
                <MainContainer>
                    <TitleWrapper><MainTitle>Welcome to UMC Movies!</MainTitle></TitleWrapper>
                    <SubWrapper>
                        <SearchBox>
                            <InputWrapper>
                                <InputBox 
